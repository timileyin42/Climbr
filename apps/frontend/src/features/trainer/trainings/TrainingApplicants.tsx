      ...
      <div className="flex items-start justify-between mb-2">
        <div className="flex items-center gap-3">
          {applicant.avatar_url
            ...
            : <div className="w-10 h-10 rounded-full flex items-center justify-center text-[13px] font-[700] shrink-0" style={{ background: '#FFF8E0', color: 'var(--color-brand-navy)' }}>{initials}</div>
          }
          <div>
                    ...
                    <td className="px-5 py-4">
                      <div className="flex items-center gap-3">
                        {a.avatar_url
                          ...
                          : <div className="w-9 h-9 rounded-full flex items-center justify-center text-[12px] font-[700] shrink-0" style={{ background: '#FFF8E0', color: 'var(--color-brand-navy)' }}>{`${a.first_name[0] ?? '?'}${a.last_name[0] ?? '?'}`}</div>
                        }
