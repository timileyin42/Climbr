...
const testimonials = [
  { name: 'bukky', company: 'Miro', quote: '"I applied for two gigs on Climbr and landed one in a week. No stress, no fake promises. It just worked. This is what job hunting should feel like."', bg: 'bg-white', nameColor: 'text-[var(--color-brand-navy)]', textColor: 'text-[var(--color-text-secondary)]' },
